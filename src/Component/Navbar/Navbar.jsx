...
const Navbar = () => {
    ...
    return (
        <div className='flex flex-col mb-[1px]'>
            ...
            <section className={`${isOpenGeneral ? 'bg-gray-100' : ''} rounded-md mb-[1px]`}>
                <div
                    className={`flex items-center justify-between cursor-pointer p-2 w-full gap-2 hover:bg-gray-100 mb-[1px] rounded-md ${isOpenGeneral ? 'hover:bg-gray-100' : ''}`}
                ...
                >
                    ...
                    <span>{isOpenGeneral ? <FaAngleUp /> : <FaAngleDown />}</span>
                </div>
            ...
            <section className={`${isOpenOrder ? 'bg-gray-100' : ''} rounded-md mb-[1px]`}>
                <div
                ...
                {isOpenOrder && (
                    <div className="rounded-md p-2 bg-gray-100">
                        {/* ************************************************* */}
                        <Link to='/recentOrders' className={`mb-[1px] font-semibold p-2 rounded-md flex gap-2 items-center justify-start ${location.pathname === '/recentOrders' ? 'bg-[#6E3FF3] text-white' : 'hover:bg-[#6E3FF3] hover:text-white'
                            }`}>
                            <CiInboxIn />
                            <span>Recent Orders</span>
                        </Link>
                        {/* ************************************************* */}
                        <Link to='/ordersDeadline' className={`mb-[1px] font-semibold p-2 rounded-md flex gap-2 items-center justify-start ${location.pathname === '/ordersDeadline' ? 'bg-[#6E3FF3] text-white' : 'hover:bg-[#6E3FF3] hover:text-white'
                            }`}>
                            <FaClockRotateLeft />
